...
import { buddyProfileProps, reviewProps } from 'types/types';
import { useAuthStore } from 'utils/stores';
import { parseCookies } from 'nookies';
import { getBuddyDetails, refreshToken } from 'api';
import { useRouter } from 'next/navigation';
import ReviewMobile from './_MobileVersion';
import ReviewPC from './_PCVersion';
...
export default function ReviewPage() {
    ...
    return (
        <div>
            {
                isMobile ?
                <ReviewMobile buddyInfo={buddyInfo} />
                :
                <ReviewPC buddyInfo={buddyInfo} />
            }
        </div>
    );
}