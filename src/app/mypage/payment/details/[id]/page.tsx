    ...
    return (
        <div className="reservation_details">
            <div className={`wrapper ${isMobile ? 'mobile' : ''}`}>
                {/* Header */}
                <Header title={details.reservation.label === "취소완료" ? t("취소 상세") : t("결제 상세")} isDepth={true} isLogin={userInfo !== null} />
                {
                    loading ? '' :
                    <div className="contents">
                        ...
                        <div className="section price_wrap">
                            <div className="calculate_price">
                                <div className="sub_title">{t("결제 내역")}</div>
                                <div className="row border_top">
                                    <div className="cate">{t("결제 상태")}</div>
                                    <div className="price">{t(details.status)}</div>
                                </div>
                                <div className="row">
                                    <div className="cate">{t("결제 일시")}</div>
                                    <div className="price">{details.reservation.createdAt?.toLocaleString()}</div>
                                </div> 
                                <div className="row">
                                    <div className="cate">{t("결제 수단")}</div>
                                    <div className="price">{t(details.method)}</div>
                                </div>
