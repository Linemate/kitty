            ...
            <div className={`wrapper ${isMobile ? 'mobile' : ''}`}>
                <div className="contents">
                    <div className="img_area sending">
                        {t("이미지")}</div>
                    <div className="title">{t("인증 메일이 발송되었습니다.")}</div>
                    <div className="desc">
                        <span className='email'>{email}</span>{t("으로 인증 메일이 발송되었습니다.")}<br/>
                        {t("받으신 메일에서 인증 버튼을 누르면 가입이 완료됩니다.")}</div>
                    
                    <div className="btn_area">
                        <div className="text gray">{t("이메일을 받지 못하셨나요?")}</div>
                        <Button 
                            type="text" 
