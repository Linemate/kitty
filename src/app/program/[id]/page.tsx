                    ...
                    <div className="contents_recommend">
                        ...
                        {isMobile ? (
                            <div className="four_area">
                                <div className="slide">
                                    <div className="slide_item">{/* <Program programName={'MAKE A TRADITIONAL FOOD'} programInfo={'If you looking for fun, please click here.'} numberOfLike={1267} where={'GangNam'} amount={50000} id={1} /> */}</div>
                                </div>
                                <div className="slide">
